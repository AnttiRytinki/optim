...
TestProblem SphereProblem = {.name = "Sphere",
                             .dim = 2,
                             .lower = -5.12,
                             .upper = 5.12,
...
TestProblem RastriginProblem = {.name = "Rastrigin",
                                .dim = 2,
                                .lower = -5.12,
                                .upper = 5.12,
...
TestProblem RosenbrockProblem = {.name = "Rosenbrock",
                                 .dim = 2,
                                 .lower = -2.0,
                                 .upper = 2.0,
...
TestProblem AckleyProblem = {.name = "Ackley",
                             .dim = 2,
                             .lower = -5.0,
                             .upper = 5.0,
...
TestProblem HimmelblauProblem = {.name = "Himmelblau",
                                 .dim = 2,
                                 .lower = -5.0,
                                 .upper = 5.0,

                                 .optimumCount = 4,
                                 .optima = {{3.000000, 2.000000},
                                            {-2.805118, 3.131312},
                                            {-3.779310, -3.283186},
                                            {3.584428, -1.848126}},
...
TestProblem GriewankProblem = {.name = "Griewank",
                               .dim = 2,
                               .lower = -600.0,
                               .upper = 600.0,
